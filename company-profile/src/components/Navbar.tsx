  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (currentScrollY > lastScrollY && currentScrollY > 20) {
        setIsBlur(true);         // Scroll ke bawah: blur
        setIsHidden(true);       // Dan hide
      } else {
        setIsBlur(false);        // Scroll ke atas: solid
        setIsHidden(false);      // Show
      }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-20">
        ...
        <div className="hidden md:flex space-x-6 items-center">
          ...
          <div className="relative">
            ...
            {isDropdownOpen && (
              <ul className="absolute bg-yellow-500/50 backdrop-blur text-black mt-2 w-40 py-2 rounded-lg shadow-lg right-0">
